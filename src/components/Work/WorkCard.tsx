...
const WorkCard : React.FC<WorkCardProps> = (props : WorkCardProps) => {
    ...
    return(
        <article className="my-2 flex w-full rounded-md shadow-2xl dark:border-2 py-14 font-author lg:my-8 lg:items-center lg:justify-around" style={{backgroundColor: backgroundColor}}>
            <div className="mx-auto w-full px-16 flex flex-col justify-center lg:w-7/12 lg:px-0">
                <h1 className="mb-3 w-full text-6xl font-medium opacity-900 lg:text-3xl" style={{color: textColor}}>
                    {title}
                </h1>
                <p className="text-3xl w-full font-medium leading-normal opacity-80 lg:text-sm lg:max-w-[290px]" style={{color: textColor}}>
                    {description}
                </p>
                <div className="flex items-center justify-start">
                    {github && (
                        <div className="mt-4 flex">
                            ...
                            <svg className="mr-4 w-12 h-12 lg:w-[20px] lg:h-[20px]" width="20px" height="20px" fill={textColor} viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {live && (
                        <div className="mt-4 flex">
                            <a href={live} target="_blank">
                                <>
                                <svg className="mr-4 w-12 h-12 lg:w-[20px] lg:h-[20px]f" width="20" height="20" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
